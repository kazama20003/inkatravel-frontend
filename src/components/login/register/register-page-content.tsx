...
export default function RegisterPageContent() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      console.log("Enviando datos de registro:", { email: formData.email, fullName: formData.fullName })
      ...
      if (error && typeof error === "object" && "response" in error) {
        ...
        if (axiosError.response?.status === 400) {
          ...
          toast.error("El email ya existe", {
            description: "Este email ya está registrado. Intenta con otro",
          })
    ...
    <div className="min-h-screen bg-white flex">
      ...
      <div className="w-full lg:w-1/2 flex flex-col justify-center px-6 md:px-12 lg:px-16 xl:px-24">
        ...
        >
          ...
          <p className="text-peru-dark/70 body-text text-lg">Únete a nuestra comunidad de viajeros y explora Perú</p>
        </motion.div>
        ...
        >
          ...
          <label className="flex items-start">
            ...
            />
            <span className="ml-2 text-sm text-peru-dark/70 body-text">
              Acepto los{" "}
          ...
          <div className="flex justify-center">
            <button
              ...
              disabled={isLoading}
              className="w-full flex items-center justify-center px-6 py-3 border border-gray-300 rounded-md hover:border-peru-orange disabled:opacity-50 transition-colors group"
            >
      ...
      >
        ...
        <div className="absolute bottom-0 left-0 p-12 text-white">
          ...
          >
            <h2 className="text-4xl brand-text text-peru-gold mb-4">EXPLORA PERÚ</h2>
            <p className="text-lg body-text text-white/90 max-w-md">
              Únete a miles de viajeros que descubren la magia de nuestro país.
            </p>
            <div className="mt-8 flex items-center space-x-4">
              ...
              <span className="text-peru-gold body-text">Comienza tu aventura</span>
            </div>
          </motion.div>
        </div>
      </motion.div>
